...
| B-003 | The display task owns LVGL and awaits panel refresh inside its event cycle. | `src/firmware/display/presentation.rs` | Measure service gaps separately from shell transition time. |
