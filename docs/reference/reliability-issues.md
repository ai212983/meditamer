...
- Evidence:
  - [docs/plans/cold-boot-validation.md](../plans/cold-boot-validation.md) marks this as deferred.
  - [docs/plans/cold-boot-validation.md](../plans/cold-boot-validation.md) explains battery-backed power persistence.
  - [docs/plans/cold-boot-validation.md](../plans/cold-boot-validation.md) requires 5/5 true cold-boot passes.
- Mitigation path:
