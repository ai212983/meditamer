...
| External SPI flash | 4 MiB | Persistent bootloader, metadata, state, and firmware storage. The accepted layout has two 2,031,616-byte application slots; see the [signed A/B decision](../../../architecture/0009-ab-firmware-update-foundation.md). |
