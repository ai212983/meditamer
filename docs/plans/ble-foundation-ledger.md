...
| 1S. Exclusive radio handoff | In progress | P1; resident coexistence infeasible | P1S-A1–P1S-A5 | E-0010, F-0008, [CAP-0009](ble-phase1s-capacity-recovery-ledger.md#cap-0009--formal-20-cycle-gate-passed-clean-no-capacity-candidate-needed) | R-003–R-004, R-012, R-018–R-019 | Capacity (P1S-A4) passed clean on exact commit `9606e152...`; run the [Wi-Fi regression gate](../guides/wifi-regression-gate.md) on the same artifact to close the remaining plan acceptance item. |
