...
pub fn run(sniffer: &mut Sniffer<'_>) {
    ...
    if let Err(err) = sniffer.set_promiscuous_mode(true) {
        println!("nostd_wifi_control: promisc_enable=err err={:?}", err);
        return;
    }
    ...
    for channel in CHANNELS {
        ...
        agg.4 += misc;
        println!(
            "nostd_wifi_control: promisc_window channel={} dwell_us={} set_channel_rc={} total={} mgmt={} ctrl={} data={} misc={}",
    ...
    println!(
        "nostd_wifi_control: promisc_diag get_channel_rc={} restore_rc={} disable_ok={} total={} mgmt={} ctrl={} data={} misc={}",
