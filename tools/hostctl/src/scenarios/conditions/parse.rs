...
use crate::scenarios::conditions::lookup_path_value;
use anyhow::anyhow;
use anyhow::Result;
...
pub(crate) fn tokenize(raw: &str) -> Result<Vec<Token>> {
...
impl ExprParser<'_> {
    pub(crate) fn parse_or(&mut self) -> Result<Value> {
...
pub(crate) fn coerce_bool(value: &Value) -> Result<bool> {
    match value {
