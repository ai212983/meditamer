...
pub use net::{
    is_ready, net_status_line_re, netcfg_set_payload, parse_net_status_line,
    parse_scan_done_count, preflight, query_net_status, query_net_status_line, wait_net_ack,
};
