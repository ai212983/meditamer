...
pub(crate) fn print_blob_state(label: &str) {
    ...
    println!(
        "legacy_nostd_wifi_control: blob_state label={} g_wifi_nvs_slot_ptr=0x{:08x} g_wifi_nvs_ptr=0x{:08x} wifi_nvs_byte_00=0x{:02x} wifi_nvs_byte_35c=0x{:02x}",
        label,
        g_wifi_nvs_slot_ptr,
        wifi_nvs_ptr,
    ...
    println!(
        "legacy_nostd_wifi_control: blob_chm label={} chm_ptr=0x{:08x} op_chan=0x{:02x} op_mode=0x{:02x} ptr_08=0x{:x} ptr_0c=0x{:x} home_chan=0x{:02x} current_chan=0x{:02x}",
        label,
        chm_ptr,
    ...
    println!(
        "legacy_nostd_wifi_control: blob_scan label={} scan_ptr=0x{:08x} word_30=0x{:08x} word_34=0x{:08x} byte_44=0x{:02x} byte_45=0x{:02x} flags_70=0x{:02x} flags_71=0x{:02x} word_114=0x{:08x}",
        label,
        scan_ptr,
