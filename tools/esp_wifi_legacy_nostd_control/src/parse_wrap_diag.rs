...
const OFFSETS: [usize; FIELD_COUNT] = [0x3c, 0x5d, 0x5e, 0x5f, 0x7c, 0x84, 0x88, 0x8c];
...
unsafe extern "C" {
    ...
    fn __real_ieee80211_parse_wapi(
        a2: usize,
        a3: usize,
        a4: usize,
        a5: usize,
...
#[unsafe(no_mangle)]
unsafe extern "C" fn __wrap_ieee80211_parse_wpa(
    a2: usize,
    a3: usize,
    a4: usize,
    a5: usize,
    ...
    unsafe { wrap_parse(1, __real_ieee80211_parse_wpa, a2, a3, a4, a5, a6, a7) }
}

#[unsafe(no_mangle)]
unsafe extern "C" fn __wrap_ieee80211_parse_rsn(
    a2: usize,
    a3: usize,
    a4: usize,
    a5: usize,
    ...
    unsafe { wrap_parse(2, __real_ieee80211_parse_rsn, a2, a3, a4, a5, a6, a7) }
}

#[unsafe(no_mangle)]
unsafe extern "C" fn __wrap_ieee80211_parse_wapi(
    a2: usize,
    a3: usize,
    a4: usize,
    a5: usize,
    ...
    unsafe { wrap_parse(3, __real_ieee80211_parse_wapi, a2, a3, a4, a5, a6, a7) }
}

pub(crate) fn reset_parse_wrap_diag() {
...
pub(crate) fn print_parse_wrap_diag(label: &str, phase: &str) {
    let count = NEXT_SLOT.load(Ordering::Relaxed).min(SLOT_COUNT);
    println!(
        "legacy_nostd_wifi_control: parse_wrap_diag label={} phase={} count={}",
        label, phase, count
    );
    for idx in 0..count {
        let snap = unsafe { SNAPSHOTS[idx] };
        println!(
            "legacy_nostd_wifi_control: parse_wrap_diag_entry label={} phase={} idx={} fn={} ret=0x{:08x} arg0=0x{:08x} arg1=0x{:08x} arg2=0x{:08x} arg3=0x{:08x}",
            label,
            phase,
            idx,
            fn_label(snap.fn_id),
        ...
        for ptr_idx in 0..PTR_ARG_COUNT {
            ...
            println!(
                "legacy_nostd_wifi_control: parse_wrap_diag_fields label={} phase={} idx={} fn={} ptr_idx={} pre={:02x}:{:02x}:{:02x}:{:02x}:{:02x}:{:02x}:{:02x}:{:02x} post={:02x}:{:02x}:{:02x}:{:02x}:{:02x}:{:02x}:{:02x}:{:02x}",
                label,
                phase,
                idx,
                fn_label(snap.fn_id),
