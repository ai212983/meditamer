...
include!("inkplate_hal/core_impl.inc.rs");
include!("inkplate_hal/display_impl.inc.rs");
include!("inkplate_hal/control_impl.inc.rs");
include!("inkplate_hal/panel_impl.inc.rs");
include!("inkplate_hal/clean_impl.inc.rs");
include!("inkplate_hal/i2c_impl.inc.rs");
include!("inkplate_hal/waveform_impl.inc.rs");
include!("inkplate_hal/graphics_impl.inc.rs");
