...
include!("core_impl.inc.rs");
include!("display_impl.inc.rs");
include!("control_impl.inc.rs");
include!("panel_impl.inc.rs");
include!("clean_impl.inc.rs");
include!("i2c_impl.inc.rs");
include!("waveform_impl.inc.rs");
include!("graphics_impl.inc.rs");
