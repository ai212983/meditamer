use super::super::{
    ...
    BQ27441_COMMAND_SOC, FG_GPOUT, FUEL_GAUGE_ADDR, INT1_LSM, INT2_LSM, IO_INT_ADDR, LSM6DS3_ADDR,
    LSM6DS3_DOUBLE_TAP_BIT, LSM6DS3_REG_CTRL1_XL, LSM6DS3_REG_CTRL2_G, LSM6DS3_REG_INT_DUR2,
    LSM6DS3_REG_MD1_CFG, LSM6DS3_REG_OUTX_L_G, LSM6DS3_REG_TAP_CFG1, LSM6DS3_REG_TAP_SRC,
    LSM6DS3_REG_TAP_THS_6D, LSM6DS3_REG_WAKE_UP_THS, LSM6DS3_REG_WHO_AM_I, LSM6DS3_TAP_EVENT_BIT,
