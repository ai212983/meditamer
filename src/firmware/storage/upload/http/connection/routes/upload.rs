...
pub(super) async fn handle_upload_begin(
    ...
    observability::log_stack_headroom("http_upload_begin_route_entry");
...
pub(super) async fn handle_upload(
    ...
    observability::log_stack_headroom("http_upload_route_entry");
    let content_length = required_content_length(socket, request.content_length).await?;
    ...
    observability::log_stack_headroom("http_upload_sd_begin_before");
    sd_upload_or_http_error(
        socket,
        SdUploadCommand::Begin {
            path,
    ...
    .await?;
    observability::log_stack_headroom("http_upload_sd_begin_after");
