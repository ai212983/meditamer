...
//! connection, [`connection`] the request parsing and routing, and
//! [`diagnostics`] the logging the other three share. The buffers and loop
//! state live here.
...
use diagnostics::log_http_mem_diag;
