...
unsafe extern "C" {
    fn __real_sta_rx_cb(a2: usize, a3: usize, a4: usize, a5: usize, a6: usize, a7: usize) -> usize;
}

pub(super) fn reset_sta_rx_cb_wrap_diag() {
...
pub(super) fn log_sta_rx_cb_wrap_diag(stage: &str) {
    let count = NEXT_SLOT.load(Ordering::Relaxed).min(SLOT_COUNT);
    println!(
        "upload_http: boot_scan_only_diag sta_rx_cb_wrap_diag after={} count={}",
        stage, count
    );
    for idx in 0..count {
        let snap = unsafe { SNAPSHOTS[idx] };
        println!(
            "upload_http: boot_scan_only_diag sta_rx_cb_wrap_diag_entry after={} idx={} arg0=0x{:08x} arg1=0x{:08x} arg2=0x{:08x} arg3=0x{:08x} ret=0x{:08x} pre_mac_isr={} post_mac_isr={}",
            stage,
            idx,
            snap.args[0],
            snap.args[1],
...
#[unsafe(no_mangle)]
unsafe extern "C" fn __wrap_sta_rx_cb(
    a2: usize,
    a3: usize,
    a4: usize,
    a5: usize,
    ...
    let ret = unsafe { __real_sta_rx_cb(a2, a3, a4, a5, a6, a7) };
