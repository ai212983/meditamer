...
pub(crate) struct SurfaceRegistry<const PROVIDER_CAPACITY: usize, const SURFACE_CAPACITY: usize> {
    ...
    SurfaceRegistry<PROVIDER_CAPACITY, SURFACE_CAPACITY>
{
    ...
    pub(crate) fn resolve(&self, surface: SurfaceRef) -> Result<&SurfaceDefinition, ResolveError> {
    ...
    pub(crate) fn validate_owner(&self, owner: ProviderToken) -> Result<(), ResolveError> {
    ...
    pub(crate) fn unregister_provider(&mut self, owner: ProviderToken) -> usize {
