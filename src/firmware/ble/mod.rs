...
fn log_phase1d_sample(stage: &'static str, cycle: u8) -> SampleResult {
    crate::firmware::telemetry::record_stack_headroom();
    let heap = crate::firmware::psram::allocator_memory_snapshot();
    let main_stack = crate::firmware::telemetry::minimum_stack_headroom_bytes();
    let touch_stack = crate::firmware::telemetry::minimum_touch_core_stack_headroom_bytes();
